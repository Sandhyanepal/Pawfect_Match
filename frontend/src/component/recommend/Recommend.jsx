...
const StarIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="currentColor" stroke="currentColor" strokeWidth="2" className="w-4 h-4 mr-1 text-yellow-500">
    <polygon points="12 2 15.09 8.26 22 9.27 17 14.14 18.18 21.02 12 17.77 5.82 21.02 7 14.14 2 9.27 8.91 8.26 12 2" />
  </svg>
);

const ActivityIcon = () => (
  <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" className="w-4 h-4 mr-2">
    <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
  </svg>
);

const PetRecommendations = () => {
  const preferences = useSelector((state) => state.loginStatus.userDetail.preferences);
    ...
    <NavLink to={`/pet/${pet.pet._id}`} className="block">
      <div className="bg-white rounded-lg shadow-md overflow-hidden transition-all hover:shadow-lg">
        <div className="relative">
          <img
            src={`${import.meta.env.VITE_BACKEND_URL}/${pet.pet.image.slice(6)}`}
            alt={pet.pet.name}
        ...
        <div className="p-4">
          ...
          <div className="space-y-2">
            ...
            <div className="flex flex-wrap gap-2">
              ...
              <span className={`px-2 py-1 text-sm rounded-full ${pet.pet.vaccination_status === "vaccinated"
